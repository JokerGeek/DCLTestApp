...
import jjwork.controller.ControllerService.OnCtrHWUpdateListener;
...
public class Sub1Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ControllerService hw = ControllerService.getInstance();
		hw.bind(this);
		hw.setGetA3Listener(new OnCtrHWUpdateListener() {			
			@Override
			public void onDataUpdate(ControllerService hw) {
